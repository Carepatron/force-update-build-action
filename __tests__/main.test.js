...
it.skip('should set output to current count when no PRs associated with commit', async () => {
...
it('should set output to 0 when repository variable is not found', async () => {
